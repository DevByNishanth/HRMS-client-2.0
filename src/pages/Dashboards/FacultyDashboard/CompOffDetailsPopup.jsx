        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 table-custom-scrollbar">
          <div className="rounded-lg border border-[#1d395e] bg-[#0a1a2d] p-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[12px] font-medium text-[#8ca1bd]">{request.facultyId?.facultyId}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3 rounded-lg border border-[#1d395e] bg-[#0a1a2d] p-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <div className="flex items-center gap-2 text-[12px] font-medium text-[#9eb0cc]">From Date</div>
                <p className="mt-1 text-[15px] font-medium text-white">{formatDate(request.fromDate)}</p>
              </div>
              <div>
                <div className="flex items-center gap-2 text-[12px] font-medium text-[#9eb0cc]">To Date</div>
                <p className="mt-1 text-[15px] font-medium text-white">{formatDate(request.toDate)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3 rounded-lg border border-[#1d395e] bg-[#0a1a2d] p-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <div className="flex items-center gap-2 text-[12px] font-medium text-[#9eb0cc]">Days</div>
