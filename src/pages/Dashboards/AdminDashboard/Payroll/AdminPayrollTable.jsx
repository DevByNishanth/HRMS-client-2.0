          ...
          {tableData.map((item, index) => (
            ...
            >
              ...
              <td className="px-6 py-3">
                <button
                  type="button"
                  className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#c4c6d010] transition hover:bg-[#3984ff30] hover:text-[#3984ff]"
                  title="Download payslip"
                >
                  <Download size={15} className="text-[#8ca1bd]" />
                </button>
              </td>
            </tr>
          ))}
