...
//   const hasFilters =
//     employeeSearch || department || category || fromDate || shift || toDate ||lateCheckIn;
...
//   useEffect(() => {
//     setVisibleCount(10);
//   }, [employeeSearch, department, category, fromDate, shift, toDate]);
...
//   useEffect(() => {
//     fetchAttendanceData();
//   }, [selectedEmployee, department, category, fromDate, toDate,checkInStatus]);
...
//       };
//       // if (checkInStatus !== "Late Punch In") {
...
//             className="w-[200px]"
//             value={lateCheckIn}
//             placeholder="Select Late Check In"
//             options={["Late Punch In"]}
...
//                       <div className="text-[#9eb0cc] text-xs">{row.empId}</div>
//                     </div>
//                   </td>

//                   <td className="px-4 py-3">{row.department}</td>

//                   <td className="px-4 py-3">{row.employeeCategory}</td>
