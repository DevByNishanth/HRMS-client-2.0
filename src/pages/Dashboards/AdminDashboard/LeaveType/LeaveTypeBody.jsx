        ...
        <div className="p-6">
                                                ...
                                                <td className="px-5 py-3">
                                                    <div className="flex items-center justify-center gap-3">
                                                        ...
                                                        <button
                                                            ...
                                                            className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#0D213B] text-blue-400/60 transition hover:bg-[var(--theme-border)] hover:text-[var(--theme-text-main)] cursor-pointer"
                                                        >
            ...
            {deletingLeaveType && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#020817]/70 px-4 backdrop-blur-[4px]">
                    <div className="w-full max-w-[420px] rounded-xl border border-[var(--theme-border)] bg-[var(--theme-bg-body)]">
                        ...
                        <div className="px-4 py-3">
                            ...
                            <p className="mt-2 text-[13px] text-[var(--theme-text-muted)]">
                        ...
                        <div className="mt-5 flex items-center justify-end gap-2 px-4 mb-3">
                            <button
                                ...
                                className="inline-flex h-10 items-center justify-center rounded-lg border border-[var(--theme-border-input)] bg-[var(--theme-bg-input)] px-6 text-sm font-medium text-[var(--theme-text-table-body)] cursor-pointer"
                            >
                                Cancel
                            </button>
