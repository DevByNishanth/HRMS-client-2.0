...
const GlassActiveDayCalendar = () => {
  return (
    <section
      className="
    relative w-[50%]    border border-white/20 bg-[#ffffff12] backdrop-blur-2xl rounded-2xl
    p-5
  "
    >
      {/* Light reflection */}
      ...
      {/* Top glass shine */}
      <div className="absolute top-0 left-0 h-px w-full bg-white/30" />
...
export default GlassActiveDayCalendar;
